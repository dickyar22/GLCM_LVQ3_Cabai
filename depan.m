...
%      DEPAN, by itself, creates a new DEPAN or raises the existing
%      singleton*.
%
%      H = DEPAN returns the handle to a new DEPAN or the handle to
%      the existing singleton*.
%
%      DEPAN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DEPAN.M with the given input arguments.
%
%      DEPAN('Property','Value',...) creates a new DEPAN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before depan_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to depan_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 25-Oct-2016 19:38:49
